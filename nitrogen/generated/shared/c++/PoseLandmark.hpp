...
namespace margelo::nitro::aiposesuggestor::poseplugin {
  ...
  public:
    ...
    double presence     SWIFT_PRIVATE;

  public:
    PoseLandmark() = default;
    explicit PoseLandmark(double x, double y, double z, double visibility, double presence): x(x), y(y), z(z), visibility(visibility), presence(presence) {}
...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::aiposesuggestor::poseplugin::PoseLandmark> final {
    static inline margelo::nitro::aiposesuggestor::poseplugin::PoseLandmark fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::aiposesuggestor::poseplugin::PoseLandmark(
        ...
        JSIConverter<double>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "presence")))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::aiposesuggestor::poseplugin::PoseLandmark& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "presence"), JSIConverter<double>::toJSI(runtime, arg.presence));
      return obj;
    }
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<double>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "presence")))) return false;
      return true;
    }
  };
