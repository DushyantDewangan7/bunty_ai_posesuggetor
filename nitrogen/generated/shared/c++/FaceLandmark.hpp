...
namespace margelo::nitro::aiposesuggestor::poseplugin {
  ...
  public:
    ...
    explicit FaceLandmark(double x, double y, double z): x(x), y(y), z(z) {}
...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::aiposesuggestor::poseplugin::FaceLandmark> final {
    static inline margelo::nitro::aiposesuggestor::poseplugin::FaceLandmark fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::aiposesuggestor::poseplugin::FaceLandmark(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::aiposesuggestor::poseplugin::FaceLandmark& arg) {
